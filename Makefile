...
all:$(output_dir)xcarriage.stl $(output_dir)extruders.stl $(output_dir)idlers.stl $(output_dir)beltclamps.stl $(output_dir)fanduct.stl $(output_dir)big_gear_80T.stl $(output_dir)bridge.stl
