...
all:dual-budda-xcarriage.stl dual-budda-extruders.stl dual-budda-idlers.stl dual-budda-beltclamps.stl dual-budda-fan_duct.stl
...
dual-budda-fan_duct.stl: $(carriage_source)
	$(oscad) -o $@ -D draw_carriage=0 -D draw_belt_clamps=0 -D draw_fan_duct=1 $(carriage_source)
